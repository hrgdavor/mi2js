describe( 'util/agregate.js', function () { 
	...
	it('/ agregate', function () { 
		var result = mi2.agregate(agrDef, rows);
	...
	it('/ compute', function () { 
		...
		mi2.addComputedColumns(computeConf, result);
	...
	it('/ combine', function () { 
		var result1 = mi2.agregate(agrDef, rows);
		var result2 = mi2.agregate(agrDef, []);

		var result = mi2.combineResults(agrDef, [result2, result1]);
